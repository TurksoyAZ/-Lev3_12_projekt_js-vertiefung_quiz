...
data.forEach(el => {
    ...
    container.classList.add('forContent')
    ...
    //forQuestion
    let frage = document.createElement('p')
    frage.textContent = el.question
    frage.classList.add('forQuestion')
    container.appendChild(frage)
    content.appendChild(container)

    //for button and function question and answer
    el.choice.forEach(choice => {

        let btn = document.createElement('button')
        btn.textContent = choice
        btn.classList.add('forBtn')
        ...
        btn.addEventListener('click', () => {
            ...
            if (el.answer === choice) {
                ...
                btn.classList.add('bckColorRed')
                setTimeout(() => { btn.classList.remove('bckColorRed') }, 300)
...
//     //forFrage
//     let frage = document.createElement('p')
//     frage.textContent = e.question
//     container.appendChild(frage)
//     content.appendChild(container)
//     //forAntwort
//     e.choice.forEach(antwort => {
